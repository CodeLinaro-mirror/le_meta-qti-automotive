...
DEPENDS += "${@bb.utils.contains_any('MACHINE', 'sa8797', bb.utils.contains_any('MACHINE_FEATURES', 'qti-multimedia qti-disply qti-audio qti-graphics qti-camera', 'mm-vfio-devicetree', '', d), '', d)}"
...
do_make_dtb[depends] += "${@bb.utils.contains_any('MACHINE', 'sa8797', bb.utils.contains_any('MACHINE_FEATURES', 'qti-multimedia qti-disply qti-audio qti-graphics qti-camera', 'mm-vfio-devicetree:do_deploy', '', d), '', d)}"
