...
SRC_URI:qclinux-gvm-gen5 = "${PATH_TO_REPO}/kernel_platform/bootable/bootloader/edk2/.git;protocol=${PROTO};destsuffix=kernel_platform/bootable/bootloader/edk2;usehead=1"
...
S:qclinux-gvm-gen5 = "${WORKDIR}/kernel_platform/bootable/bootloader/edk2"
