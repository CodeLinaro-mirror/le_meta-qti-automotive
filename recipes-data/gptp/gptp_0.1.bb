...
# On qclinux-gvm-gen5 only, invert the two flags above.
EXTRA_OEMAKE:remove:qclinux-gvm-gen5 = "AVB_FEATURE_GVM_MODE=1"
EXTRA_OEMAKE:append:qclinux-gvm-gen5 = "ENABLE_GPTP_SERVICE=1"
